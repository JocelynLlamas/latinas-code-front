      ...
      <div class="row">
        <div class="col-md-8 col-sm-12">
          <div class="banner-text">
            ...
            <ul>
              <li><a href="#"><img src="/frontend/images/appstore.png" class="wow fadeInUp" data-wow-delay="0.4s"/></a></li>
              <li><a href="#"><img src="/frontend/images/playstore.png" class="wow fadeInUp" data-wow-delay="0.7s"/></a></li>
            </ul>
          </div>
        </div>
        <div class="col-md-4 col-sm-12"> <img src="/frontend/images/iphone-screen.png" class="img-fluid wow fadeInUp"/> </div>
      </div>
    </div>
  </div>
